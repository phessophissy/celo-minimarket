...
This document covers the changelog aspect of the Celo MiniMarket project.

## Purpose

The VERSIONING documentation provides guidance on add changelog and version history.
