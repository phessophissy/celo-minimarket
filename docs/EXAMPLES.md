...
This document covers the api-docs aspect of the Celo MiniMarket project.

## Purpose

The EXAMPLES documentation provides guidance on add smart contract API documentation.
