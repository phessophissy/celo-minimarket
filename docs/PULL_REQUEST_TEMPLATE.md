...
This document covers the contributing aspect of the Celo MiniMarket project.

## Purpose

The PULL_REQUEST_TEMPLATE documentation provides guidance on add contributing guidelines.
