...
This document covers the deploy-docs aspect of the Celo MiniMarket project.

## Purpose

The ENVIRONMENT documentation provides guidance on add comprehensive deployment guide.
