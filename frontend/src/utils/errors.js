/**
 * errors - errors utilities for Celo MiniMarket.
...
export function initerrors() {
  console.log('[errors] Initializing errors');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: errorsConfig,
 ...
 */
export function iserrorsAvailable() {
...
export function reseterrors() {
  console.log('[errors] Resetting errors');
}
 ...
 */
export function validateerrorsData(data) {
 ...
 */
export function formaterrorsData(data) {
