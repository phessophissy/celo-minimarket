// Theme extension - Module 1
// Provides theme extension functionality (part 1)

const MODULE_NAME = 'themeExt-module-1';

/**
 * Create a theme extension handler (variant 1)
 * @param {Object} config - Configuration options
 * @returns {Object} Handler instance with lifecycle methods
 */
export function createThemeExtHandler1(config = {}) {
  const options = {
    enabled: true,
    maxRetries: 3,
...
/**
 * Transform data for theme extension module 1
 */
export function transformThemeExtData1(data, opts = {}) {
...
export const THEMEEXT_MODULE_1_DEFAULTS = {
  MAX_ITEMS: 1000,
