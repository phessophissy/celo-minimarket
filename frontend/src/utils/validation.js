/**
 * validation - validation utilities for Celo MiniMarket.
...
export function initvalidation() {
  console.log('[validation] Initializing validation');
  return {
    initialized: true,
    timestamp: Date.now(),
...
export function resetvalidation() {
  console.log('[validation] Resetting validation');
}
 ...
 */
export function validatevalidationData(data) {
 ...
 */
export function formatvalidationData(data) {
