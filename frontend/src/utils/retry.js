/**
 * retry - errors utilities for Celo MiniMarket.
...
export function initretry() {
  console.log('[errors] Initializing retry');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: errorsConfig,
...
export function resetretry() {
  console.log('[errors] Resetting retry');
}
 ...
 */
export function validateretryData(data) {
 ...
 */
export function formatretryData(data) {
