/**
 * dataExport - export utilities for Celo MiniMarket.
...
export function initdataExport() {
  console.log('[export] Initializing dataExport');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: exportConfig,
 ...
 */
export function isdataExportAvailable() {
 ...
 */
export function getdataExportState() {
  return {
    active: isdataExportAvailable(),
    config: exportConfig,
    timestamp: Date.now(),
  };
}
...
export function resetdataExport() {
  console.log('[export] Resetting dataExport');
}
 ...
 */
export function formatdataExportData(data) {
