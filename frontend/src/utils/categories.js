/**
 * categories - categories utilities for Celo MiniMarket.
 ...
 */
export function iscategoriesAvailable() {
...
export function resetcategories() {
  console.log('[categories] Resetting categories');
}
