/**
 * transactionTracker - errors utilities for Celo MiniMarket.
...
export function inittransactionTracker() {
  console.log('[errors] Initializing transactionTracker');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: errorsConfig,
 ...
 */
export function istransactionTrackerAvailable() {
 ...
 */
export function gettransactionTrackerState() {
  return {
    active: istransactionTrackerAvailable(),
    config: errorsConfig,
    timestamp: Date.now(),
  };
}
 ...
 */
export function resettransactionTracker() {
  console.log('[errors] Resetting transactionTracker');
}
 ...
 */
export function validatetransactionTrackerData(data) {
 ...
 */
export function formattransactionTrackerData(data) {
