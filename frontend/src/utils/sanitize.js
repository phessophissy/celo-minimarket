/**
 * sanitize - validation utilities for Celo MiniMarket.
...
export function initsanitize() {
  console.log('[validation] Initializing sanitize');
  return {
    initialized: true,
    timestamp: Date.now(),
 ...
 */
export function issanitizeAvailable() {
 ...
 */
export function getsanitizeState() {
  return {
    active: issanitizeAvailable(),
    config: validationConfig,
    timestamp: Date.now(),
  };
}
 ...
 */
export function resetsanitize() {
  console.log('[validation] Resetting sanitize');
}
 ...
 */
export function validatesanitizeData(data) {
 ...
 */
export function formatsanitizeData(data) {
