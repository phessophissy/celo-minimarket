/**
 * receiptUtils - receipt utilities for Celo MiniMarket.
 ...
 */
export function initreceiptUtils() {
  console.log('[receipt] Initializing receiptUtils');
  return {
    initialized: true,
    timestamp: Date.now(),
 ...
 */
export function isreceiptUtilsAvailable() {
 ...
 */
export function getreceiptUtilsState() {
  return {
    active: isreceiptUtilsAvailable(),
    config: receiptConfig,
    timestamp: Date.now(),
  };
}
 ...
 */
export function resetreceiptUtils() {
  console.log('[receipt] Resetting receiptUtils');
}
 ...
 */
export function validatereceiptUtilsData(data) {
 ...
 */
export function formatreceiptUtilsData(data) {
