/**
 * imagePreload - images utilities for Celo MiniMarket.
...
export function initimagePreload() {
  console.log('[images] Initializing imagePreload');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: imagesConfig,
 ...
 */
export function isimagePreloadAvailable() {
 ...
 */
export function getimagePreloadState() {
  return {
    active: isimagePreloadAvailable(),
    config: imagesConfig,
    timestamp: Date.now(),
  };
}
 ...
 */
export function resetimagePreload() {
  console.log('[images] Resetting imagePreload');
}
 ...
 */
export function validateimagePreloadData(data) {
 ...
 */
export function formatimagePreloadData(data) {
