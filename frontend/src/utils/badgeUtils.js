/**
 * badgeUtils - badges utilities for Celo MiniMarket.
 ...
 */
export function initbadgeUtils() {
  console.log('[badges] Initializing badgeUtils');
  return {
    initialized: true,
    timestamp: Date.now(),
    config: badgesConfig,
 ...
 */
export function isbadgeUtilsAvailable() {
 ...
 */
export function getbadgeUtilsState() {
  return {
    active: isbadgeUtilsAvailable(),
    config: badgesConfig,
    timestamp: Date.now(),
  };
}
 ...
 */
export function resetbadgeUtils() {
  console.log('[badges] Resetting badgeUtils');
}
 ...
 */
export function validatebadgeUtilsData(data) {
 ...
 */
export function formatbadgeUtilsData(data) {
